...
assert buildLog.contains('[INFO] org.apache.maven.plugins:maven-deploy-plugin:maven-plugin:3.0.0-M1 PGP Signature OK')
assert buildLog.contains('[INFO] org.apache.maven.plugins:maven-deploy-plugin:pom:3.0.0-M1 PGP Signature OK')
...
assert buildLog.contains('[INFO] org.apache.maven.plugins:maven-clean-plugin:maven-plugin:3.1.0 PGP Signature OK')
assert buildLog.contains('[INFO] org.apache.maven.plugins:maven-clean-plugin:pom:3.1.0 PGP Signature OK')
