...
public class ArtifactPatternTest {
    ...
    public Object[][] artifactsList() {
        return new Object[][]{
                ...
                {"test.group:test:1.1.1", testArtifact().version("1.1.1-SNAPSHOT").build(), false},
                {"test.group:test:1.1.1-SNAPSHOT", testArtifact().version("1.1.1-SNAPSHOT").build(), true},
                ...
                {"test.group:test:[1.1,2.0)", testArtifact().version("1.1.1-SNAPSHOT").build(),
                    // Expecting false once https://issues.apache.org/jira/browse/MNG-3092 is resolved
                    true},
                {"test.group:test:[1.1,2.0)", testArtifact().version("2.0").build(), false},
                {"test.group:test:1.1.1", testArtifact().version("1.1.2").build(), false},
                {"test.group:test:[1.1,1.1.1)", testArtifact().build(), false},
                {"test.group:test:[1.1,1.1.1)", testArtifact().version("1.1.1-SNAPSHOT").build(),
                    // Expecting false once https://issues.apache.org/jira/browse/MNG-3092 is resolved
                    true},
                {"test.group:test:[1.1,1.1.1-SNAPSHOT)", testArtifact().build(), false},
                {"test.group:test:[1.1,1.1.1-SNAPSHOT)", testArtifact().version("1.1.1-SNAPSHOT").build(), false},
                {"test.group:test:[1.1,1.1.1]", testArtifact().build(), true},
                {"test.group:test:[1.1,1.1.1]", testArtifact().version("1.1.1-SNAPSHOT").build(),
                    // Expecting false once https://issues.apache.org/jira/browse/MNG-3092 is resolved
                    true},
                {"test.group:test:[1.1,1.1.1-SNAPSHOT]", testArtifact().build(), false},
                {"test.group:test:[1.1,1.1.1-SNAPSHOT]", testArtifact().version("1.1.1-SNAPSHOT").build(), true},
                {"test.group:test", testArtifact().build(), true},
